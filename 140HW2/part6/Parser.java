...
public class Parser {
    ...
    Parser(Scan scanner) {
		...
		System.out.println("int sqrtint(int x){");
		System.out.println("if ((int)sqrt(x) < 0)");
		System.out.println("return 0;");
		System.out.println("else{");
		System.out.println("return sqrt(x);");
		System.out.println("}");
	       	System.out.println("}");
	...
	private void factor(Stack <LinkedList <String>> symboltable){
		...
		else if (tok.kind == TK.CA){
		    System.out.print("(int) pow(");
		    scan();
		    expression(symboltable);
		    System.out.println(",2)");
		}
		else if (tok.kind == TK.AT){
		    System.out.print("sqrtint(");
		    scan();
		    expression(symboltable);
		    System.out.println(")");
		}
	...
	//Prints table with info on every variable
